...
const FeatureCard = React.memo(({ title, subtitle, icon: Icon, color, onPress }: FeatureCardProps) => {
...
const HomeScreen = () => {
  ...
  const handleNavigateToDetail = useCallback(() => {
    NavigationService.navigate('DetailScreen' as any, { productId: 123 } as any);
  }, []);

  const goToRegister = useCallback(() => {
    NavigationService.navigate('RegisterScreen' as any, { productId: 123 } as any);
  }, []);
  ...
  const handleShowAlert = useCallback(() => {
    showAlert({
      ...
      buttons: [
        ...
        { text: t('home.actions.delete_now'), onPress: () => showToast(t('home.actions.deleted_success'), 'success') },
      ],
    });
  ...
  const handleChangeLanguage = useCallback(() => {
    ...
    showToast(newLang === 'en' ? t('home.actions.switched_to_en') : t('home.actions.switched_to_vi'), 'success');
  }, [showToast, t]);
